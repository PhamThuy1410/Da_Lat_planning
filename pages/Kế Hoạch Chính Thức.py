...
<style>
    ...
    body, h1, h2, .custom-metric-label, .custom-metric-value {
        font-family: 'Anton', sans-serif;
        color: white;
    }
    body { background-color: #0E1117; }
    h1 { color: #A0D683; font-size: 50px; font-weight: 700; }
    h2 { color: #B3C8CF; font-size: 40px; font-weight: 700; }
    .custom-metric-label { color: #FFE3E3; font-size: 25px; font-weight: 700; }
    .custom-metric-value { font-size: 30px; }
</style>
